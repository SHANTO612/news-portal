...
router.get('/api/news/:newsId', middleware.auth, newsControllers.get_edit_dashboard_news);
...
router.get('/api/writer/news-statistics', middleware.auth, newsControllers.getWriterNewsStatistics);
